...
export class TransactionsApi {
  ...
  addLink(listLinks200ResponseLinksInner, uuid = null) {
    // verify the required parameter 'listLinks200ResponseLinksInner' is set
    if (
      listLinks200ResponseLinksInner === undefined ||
      listLinks200ResponseLinksInner === null
    ) {
      throw new Error(
        "Missing the required parameter 'listLinks200ResponseLinksInner' when calling addLink",
      );
    }

    let path = "/transactions/{uuid}/links";
    path = path.replace("{uuid}", uuid);

    let options = {
      params: {},
      data: listLinks200ResponseLinksInner,
    };
  ...
  listLinks(fields = null, page = null, perPage = null, uuid = null) {
    let path = "/transactions/{uuid}/links";
    path = path.replace("{uuid}", uuid);
  ...
  updateLink(listLinks200ResponseLinksInner, uuid = null, linkUuid = null) {
    // verify the required parameter 'listLinks200ResponseLinksInner' is set
    if (
      listLinks200ResponseLinksInner === undefined ||
      listLinks200ResponseLinksInner === null
      ...
      throw new Error(
        "Missing the required parameter 'listLinks200ResponseLinksInner' when calling updateLink",
      );
    }
